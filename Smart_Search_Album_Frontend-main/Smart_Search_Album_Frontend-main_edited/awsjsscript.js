function getPhoto()
{
  var apigClient = apigClientFactory.newClient({
                     apiKey: "5dtdmOZvl17Fi3VAedXKV6wZpFNkP3BH8pd7IH1A"
        });
...
function submitPhoto()
{
   ...
   var base64_image = convertImgBase64(img_file).then(
     ...
     var params = {"key" : img_file.name, "bucket" : "photosksm", "Content-Type" : img_file.type, "x-amz-meta-CustomLabels": mlabels};
